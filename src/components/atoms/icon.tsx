...
const icons = {
  ...
  "user-headset": {
    ...
    body: (
      <>
        <polygon points="10 7 9 7 9 8 8 8 8 11 9 11 9 14 8 14 8 13 7 13 7 12 6 12 6 8 7 8 7 6 8 6 8 5 9 5 9 4 15 4 15 5 16 5 16 6 17 6 17 8 18 8 18 10 17 10 17 11 16 11 16 8 15 8 15 6 10 6 10 7" />
        <polygon points="20 6 20 12 19 12 19 13 18 13 18 14 16 14 16 15 10 15 10 12 13 12 13 13 17 13 17 12 18 12 18 11 19 11 19 7 18 7 18 5 17 5 17 4 16 4 16 3 15 3 15 2 9 2 9 3 8 3 8 4 7 4 7 5 6 5 6 7 5 7 5 11 4 11 4 10 3 10 3 7 4 7 4 6 5 6 5 4 6 4 6 3 7 3 7 2 8 2 8 1 16 1 16 2 17 2 17 3 18 3 18 4 19 4 19 6 20 6" />
        <path d="m21,19v-1h-1v-1h-1v-1h-4v1h-6v-1h-4v1h-1v1h-1v1h-1v3h1v1h18v-1h1v-3h-1Zm-1,2H4v-2h1v-1h3v1h8v-1h3v1h1v2Z" />
      </>
    ),
  },
} as const;
